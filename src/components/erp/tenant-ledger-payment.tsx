...
import {
  ...
  conceptsForBill,
  type BillConceptKey,
} from "@/features/billing/lib/bill-debt-concepts";
import type { BillDebtDetail } from "@/server/services/tenant-ledger";

type ConceptKey = BillConceptKey;

const CONCEPT_LABEL = BILL_CONCEPT_LABEL;
const CONCEPT_ORDER = BILL_CONCEPT_ORDER;
